...
class Solution {
    public int countMatches(List<List<String>> items, String ruleKey, String ruleValue) {
        ...
        switch (ruleKey) {
            case "type":return search( items,0, ruleValue);
            case "color":return search( items,1, ruleValue);
            case "name":return search( items,2, ruleValue);
        }
        return 0;
    }

    public int search(List<List<String>> items,int index, String ruleValue) {
        int count = 0;
